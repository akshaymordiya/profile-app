...
const themeColors = {
  primary: '#01AB55',
  primaryLight: '#1EB468',
  primaryExtraLight: '#EBF8F1',
  secondary: '#637382',
  secondaryLight: '#6E7E8B',
  success: '#57CA22',
  warning: '#FFA319',
  brown: '#C0A88D',
  brownLight: '#D7D3B4',
...
const colors = {
  ...
  shadows: {
    ...
    box: '2px 2px 14px -9px rgba(0, 0, 0, 0.25)',
  ...
  layout: {
    general: {
      bodyBg: themeColors.dullWhite
    },
    sidebar: {
      background: themeColors.white,
      textColor: themeColors.secondary,
      dividerBg: themeColors.white,
      menuItemColor: themeColors.secondary,
      menuItemColorActive: themeColors.primaryExtraLight,
      menuItemBg: themeColors.white,
      menuItemBgActive: themeColors.primaryExtraLight,
      menuItemIconColor: themeColors.secondary,
      menuItemIconColorActive: themeColors.primaryLight,
  ...
  primary: {
    lighter: themeColors.primaryLight,
    light: themeColors.primaryExtraLight,
...
export const LightTheme = createTheme({
  ...
  colors: {
    gradients: {
      ...
      border: colors.gradients.border,
      exp: colors.gradients.exp,
      meetup: colors.gradients.meetup,
      hours: colors.gradients.hours,
    },
    shadows: {
